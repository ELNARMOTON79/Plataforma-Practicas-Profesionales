    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-20">
            ...
            <div class="hidden md:flex items-center space-x-1">
                ...
                <a href="{{ route('estudiante.misSolicitudes') }}" class="{{ (isset($active) && in_array($active, ['solicitudes', 'mis-solicitudes'])) ? 'text-[#4E7D24] bg-[#6BA53A]/10 px-4 py-2 rounded-xl text-sm font-semibold transition-all' : 'text-gray-600 hover:text-[#4E7D24] hover:bg-[#6BA53A]/5 px-4 py-2 rounded-xl text-sm font-medium transition-all' }}">Solicitudes</a>
