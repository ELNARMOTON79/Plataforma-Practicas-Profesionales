...
<div id="bulkUploadModal" class="fixed inset-0 z-[100] hidden overflow-hidden" aria-labelledby="bulk-modal-title" role="dialog" aria-modal="true">
...
(function() {
    ...
    function analyzeAndPreviewData(rows) {
        ...
        for (let i = 1; i < rows.length; i++) {
            ...
            if (!nombre) student.errors.push('Nombre requerido');
            ...
            if (!carrera) student.errors.push('Carrera requerida');
            ...
            if (!grupo) student.errors.push('Grupo requerido');
    ...
    function submitImport() {
        ...
        fetch("{{ route('coordinador.alumnos.bulk-store') }}", {
            method: 'POST',
            headers: {
