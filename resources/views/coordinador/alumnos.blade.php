                    ...
                    @forelse($alumnos as $alumno)
                        ...
                        <tr class="transition-colors group {{ !$activo ? 'bg-gray-50/50 opacity-60 text-gray-400' : 'hover:bg-[#6BA53A]/5' }}">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <button type="button" onclick="openSolicitarEdicionModal('alumno', '{{ $alumno->matricula }} - {{ addslashes($alumno->nombre_completo) }}')" class="text-amber-500 hover:text-amber-700 bg-amber-50 hover:bg-amber-100 px-3 py-1.5 rounded-lg transition-colors inline-flex items-center gap-1">
