...
@section('content')
    <!-- Header Section -->
    <div class="mb-8">
        <h1 class="text-3xl font-extrabold text-gray-900 mb-1">Reportes y Exportación</h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="glass-card rounded-3xl p-8 border-t-4 border-[#6BA53A] shadow-sm hover:shadow-md transition-shadow">
            ...
            <form class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        <select class="w-full px-4 py-3 rounded-xl border border-gray-200 bg-white/60 focus:ring-2 focus:ring-[#6BA53A] focus:border-[#6BA53A] outline-none transition-all text-sm font-medium text-gray-800 shadow-inner appearance-none cursor-pointer">
        ...
        <div class="glass-card rounded-3xl p-8 border-t-4 border-[#4E7D24] shadow-sm hover:shadow-md transition-shadow flex flex-col">
            ...
            <div class="space-y-4 flex-grow flex flex-col justify-center">
                <!-- PDF Export -->
                <button class="w-full group bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white p-4 rounded-2xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1 flex items-center gap-4">
                    <div class="bg-white/20 p-3 rounded-xl group-hover:scale-110 transition-transform shadow-inner">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"></path></svg>
                    </div>
                    <div class="text-left">
                        <h3 class="font-extrabold text-lg tracking-wide uppercase">Exportar a PDF</h3>
                        <p class="text-blue-100 text-xs font-medium mt-0.5">Generar un documento PDF formateado para imprimir</p>
                    </div>
                </button>

                <!-- Excel Export -->
                <button class="w-full group bg-gradient-to-r from-[#2E5417] to-[#4E7D24] hover:from-[#1f380f] hover:to-[#2E5417] text-white p-4 rounded-2xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1 flex items-center gap-4">
                    <div class="bg-white/20 p-3 rounded-xl group-hover:scale-110 transition-transform shadow-inner">
                    ...
                    <div class="text-left">
                        ...
                        <p class="text-green-100 text-xs font-medium mt-0.5">Generar una hoja de cálculo (.xlsx) con los datos completos</p>
                    </div>
                </button>
            </div>
        </div>
