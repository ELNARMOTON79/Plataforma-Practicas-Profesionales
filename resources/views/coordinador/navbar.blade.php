...
<nav class="relative z-50 bg-white/80 backdrop-blur-md border-b border-gray-200/50 shadow-sm sticky top-0">
    ...
    <div class="hidden xl:block bg-white/40">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-center h-12 gap-1 py-1">
                ...
                <a href="{{ Route::has('coordinador.seguimiento') ? route('coordinador.seguimiento') : '#' }}" class="{{ (isset($active) && $active === 'seguimiento') ? 'text-[#4E7D24] bg-[#6BA53A]/10 px-4 py-1.5 rounded-xl text-sm font-semibold transition-all' : 'text-gray-600 hover:text-[#4E7D24] hover:bg-[#6BA53A]/5 px-4 py-1.5 rounded-xl text-sm font-medium transition-all' }}">Seguimiento</a>
    ...
    <div class="xl:hidden border-t border-gray-100 bg-white/95 py-2 overflow-x-auto whitespace-nowrap scrollbar-none flex items-center px-4 gap-2">
        ...
        <a href="{{ Route::has('coordinador.seguimiento') ? route('coordinador.seguimiento') : '#' }}" class="{{ (isset($active) && $active === 'seguimiento') ? 'text-[#4E7D24] bg-[#6BA53A]/10 px-3.5 py-1.5 rounded-lg text-xs font-semibold inline-block' : 'text-gray-600 hover:text-[#4E7D24] hover:bg-[#6BA53A]/5 px-3.5 py-1.5 rounded-lg text-xs font-medium inline-block' }}">Seguimiento</a>
