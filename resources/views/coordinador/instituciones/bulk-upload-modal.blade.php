...
<div id="institucionesBulkUploadModal" class="fixed inset-0 z-[100] hidden overflow-hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    ...
    <div class="flex items-center justify-center min-h-screen p-4 md:p-6 text-center">
        ...
        <!-- Modal panel -->
        <div class="relative flex flex-col w-full max-w-5xl bg-white rounded-3xl shadow-2xl overflow-hidden transition-all transform max-h-[90vh] z-10">
            ...
            <div class="bg-gradient-to-r from-[#4E7D24] to-[#6BA53A] px-8 py-6 flex items-center justify-between flex-shrink-0">
                <div class="flex items-center gap-3">
                    ...
                    <div class="text-left">
                        <h3 class="text-lg font-bold text-white leading-tight" id="modal-title">Subir Instituciones desde Excel</h3>
                        <p class="text-green-100 text-xs">Registra múltiples instituciones o empresas rápidamente mediante un archivo Excel o CSV.</p>
                    </div>
                </div>
                <button type="button" 
