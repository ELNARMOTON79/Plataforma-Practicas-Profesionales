...
<head>
    ...
    <title>{{ $title ?? 'Panel Empresa - Prácticas Profesionales UdeC' }}</title>
...
<body hx-boost="true" class="min-h-screen bg-gray-50 relative overflow-x-hidden flex flex-col selection:bg-[#005e20] selection:text-white">

    <!-- Animated Background -->
    <div class="fixed inset-0 z-0 overflow-hidden pointer-events-none">
        <div class="orb orb-1 opacity-10"></div>
        <div class="orb orb-2 opacity-10"></div>
    ...
    @include('empresa.navbar', ['active' => $active ?? ''])
