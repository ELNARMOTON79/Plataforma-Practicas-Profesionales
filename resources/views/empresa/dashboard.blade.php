...
<head>
    ...
    <title>Dashboard Empresa - Prácticas Profesionales</title>
    ...
    <main class="flex-1 max-w-7xl w-full mx-auto py-10 px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            <div class="flex items-center gap-4 mb-4">
                ...
                <h1 class="text-3xl font-bold text-gray-900">Bienvenido, Representante de Empresa</h1>
            </div>
            <p class="text-gray-600">Has iniciado sesión correctamente. Aquí podrás gestionar los convenios y horas de los estudiantes practicantes.</p>
        </div>
    </main>
</body>
</html>